<?php 
  ...
  require_once('db.php');
  class City extends DB implements IModel
  {
    ...
    public function getAll($page = 1,$countRows =10){
     ...
     //lọc các thành phố dựa theo tham số id tỉnh
     public function getByProvinceId($idProvince){
        $query = $this->db->query('SELECT * FROM '.
        $this->tableName.' WHERE id_province='.$idProvince);
        return $query->fetchAll();
     }
